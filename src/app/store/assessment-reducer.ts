...
import type { AssessmentState } from "../../storage/schemas"
...
export function reduceSafetyAnswers(
  state: AppStoreState,
...
export function startAssessment(state: AppStoreState): AppStoreState {
...
export function submitAssessmentSet(
  state: AppStoreState,
...
function findNextCategory(categoryId: CategoryId): CatalogCategory | null {
  ...
  return EXERCISE_CATALOG[currentIndex + 1] ?? null
}
